...
if df is None:
    ...
    if show_category_details and product_cat:
        available_product_groups = sorted(
            df_filtered[df_filtered['reporting_categories'].isin(product_cat)]['Product Group'].unique())
        selected_product_groups = st.sidebar.multiselect(
            "Select Product Groups", available_product_groups, default=available_product_groups,
